(function(){
    if (window.myBookmarklet !== undefined){
        ...
        document.body.appendChild(document.createElement('script')).src='https://f57c-87-229-242-205.ngrok.io/static/js/bookmarklet.js?r='+Math.floor(Math.random()*99999999999999999999);
    }
})();
